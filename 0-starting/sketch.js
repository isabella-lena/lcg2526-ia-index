...
function drawRocket(xRocket, yRocket, scalaB=1, ruota=30) {
  ...
  // rocket body
  //ruotare
  //prendere il pivot/centro del foglio
  //portarlo al centro del razzo
  translate(xRocket, yRocket);
  rotate(ruota);
  // opzione 1: translate(-xRocket, -yRocket);
  ...
  rect(80, 180, 20); // body rectangle with rounded corners
  // nose cone
  fill(200, 40, 40);    // red
  triangle(0-40, 0-60, 0+40, 0-60, xRocket, yRocket-120); // triangle on top
  // window (circle)
